...
export const zh = {
  ...
  collapseRightPanel: '折叠侧拉面板',
  expandRightPanel: '展开侧拉面板',
  ...
  unstageAllChanges: '全部取消暂存',
  stagedChanges: '已暂存的变更',
  unstagedChanges: '变更',
  openStagedChanges: '打开已暂存变更',
  openChanges: '打开变更',
  openFile: '打开文件',
  discardAll: '全部放弃',
  ...
  pushSuccess: '推送成功',
  pullSuccess: '拉取成功',
  fetchSuccess: '已获取最新状态',
  pushError: '推送失败',
  pullError: '拉取失败',
  fetchError: '获取失败',
  noUpstream: '当前分支没有设置上游分支',
  upToDate: '已是最新',
  ahead: '领先 {n} 个提交',
  behind: '落后 {n} 个提交',
  aheadBehind: '领先 {ahead} 个提交，落后 {behind} 个提交',
  diffEmpty: '没有文本差异',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  fetchSuccess: 'Fetched latest',
  pushError: 'Push failed',
  pullError: 'Pull failed',
  fetchError: 'Fetch failed',
  noUpstream: 'The current branch has no upstream branch',
  upToDate: 'Up to date',
  ahead: 'Ahead by {n} commit(s)',
  behind: 'Behind by {n} commit(s)',
  aheadBehind: 'Ahead by {ahead}, behind by {behind}',
